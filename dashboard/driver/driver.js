    ...
    $.ajax({
        ...
        success: function(response, text, stri) {
            ...
            if (gdata[gdata.length - 1].value == 'view') {
                ...
                $('#acceptedNum').text(acceptedcount);
                        ...
                        { data: 'status' },
                        {
                            ...
                            render: function(data, type, row, meta) {
                                ...
                                if (row.status == 'accept') {
                                   ...
                                   ])" class="" style="cursor:pointer;">Finish session</button>
                               </div>
                                `;
                                }

                                // Conditionally add deny action based on status
                                if (row.status == 'pending') {
                                    ...
                                    <i onclick="getRecords([
                                        ...
                                        { name: 'id', value: ${data} },
                                        { name: 'from', value: 'customer' },
                                        { name: 'status', value: 'granted' },
                                        { name: 'action', value: 'view' }
                                    ])" class="bg-" style="cursor:pointer"><lord-icon
                                    src="https://cdn.lordicon.com/luyemzne.json"
                                    trigger="hover"
                                    stroke="bold"
                                    ...
                                    |<div class="action-icon">
                                        ...
                                        ])" class="" style="cursor:pointer;"><lord-icon
