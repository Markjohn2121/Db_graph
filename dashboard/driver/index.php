            ...
            <div class="tableViewsWrapper">
                ...
                <div class="tbwrap tbwrap1">
                    ...
                    <div class="action-menus d-flex p-1 mb-1 flex-row  mb-3 justify-content-evenly justify-content-center" style="color:black">
                        ...
                        <h6>Total of <span id="reqNum" class=" p-1  border border-secondary rounded-1" style="background-color:greenyellow;">0</span> request for today</h6>
                        ...
                        <div class="menu-item" style=" border-right:2px solid black; padding-right:1em">
                            <!-- ADD BTN -->
                            <h6><span id="pendingNum" class=" p-1 border border-secondary rounded-1" style="background-color:greenyellow;">0</span> Pending</h6>

                        </div>
                        <div class="menu-item">
                            <!-- ADD BTN -->
                            <h6><span id="acceptedNum" class=" p-1 border border-secondary rounded-1" style="background-color:greenyellow;">0</span> Accepted request</h6>
